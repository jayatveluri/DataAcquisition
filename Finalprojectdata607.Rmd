---
title: "Final Project Sentiment Analysis Data 607"
author: "Jaya Veluri"
date: "12/5/2021"
...
hu.liu.pos = scan('C:\\RData\\positive-words.txt', what = 'character', comment.char = ';')
hu.liu.neg = scan('C:\\RData\\negative-words.txt', what = 'character', comment.char = ';')
...
stock_prices_tl <- read.csv("C:\\RData\\TSLA.csv")
...
tweet_stock_tl
 g <- graph.data.frame(tweet_stock_tl) 
 V(g)$score <- sample(1:10, vcount(g), replace=TRUE)

plot(g, layout = layout.circle,vertex.label=V(g)$text, edge.arrow.size=2)
...
```{r}
#Read stock price CSV in 
stock_prices_amzn <- read.csv("C:\\RData\\AMZN.csv")
